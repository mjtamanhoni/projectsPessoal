...
const AcompanharEncomendas = lazy(() => import('@/pages/AcompanharEncomendas').then((m) => ({ default: m.AcompanharEncomendas })));
...
const BandeiraCartao = lazy(() => import('@/pages/BandeiraCartao').then((m) => ({ default: m.BandeiraCartaoPage })));
    ...
    <ModuleProvider>
      <Suspense fallback={<Spinner fullPage />}>
        <Routes>
          ...
          {routesFor(PRODUCAO, mode) && <Route path="/bandeiras-cartao" element={<Private><BandeiraCartao /></Private>} />}
          ...
          {routesFor(PRODUCAO, mode) && <Route path="/acompanhar-encomendas" element={<Private><AcompanharEncomendas /></Private>} />}
