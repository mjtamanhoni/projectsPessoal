    ...
    columnHelper.display({
      ...
      cell: ({ row }) => (
        <div className="text-right">
          <ShowForPermission rota="/lancamento-automatico-config" acao={ACAO.EDITAR}>
            <button onClick={() => handleEdit(row.original)} className="p-1.5 rounded-lg hover:bg-bg-muted transition-colors">
              <Edit2 size={16} className="text-text-secondary" />
            </button>
          </ShowForPermission>
          <ShowForPermission rota="/lancamento-automatico-config" acao={ACAO.EXCLUIR}>
