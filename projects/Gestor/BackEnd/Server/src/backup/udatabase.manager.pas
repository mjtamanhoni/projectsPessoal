...
type
  ...
  private
    procedure RecalcularCustoMedio(const aInsumoId: Integer; const aEmpresaId: Integer; const aFDConnection: TZConnection);
    procedure AtualizarEstoqueInsumo(const aInsumoId: Integer; const aDelta: Double; const aDataAtualizacao: TDateTime; const aEmpresaId: Integer; const aFDConnection: TZConnection);
    procedure AtualizarEstoqueProdutoFabricado(const aProdutoFabricadoId: Integer; const aDelta: Double; const aDataAtualizacao: TDateTime; const aEmpresaId: Integer; const aFDConnection: TZConnection);
  public
    constructor Create;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 400;
        Result.Menssage := 'JSon n�o informado.';
        Exit;
      end;
      ...
      begin
        LObj := AJSon.Items[I] as TJSONObject;

        if Trim(LObj.GetValue('nome','')) = '' then
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome do Fornecedor n�o informado.';
        ...
        FDQ_Append.ParamByName('id').AsInteger := LObj.GetValue('codigo', 0);
        FDQ_Append.ParamByName('nome').AsString := Trim(LObj.GetValue('nome', ''));
        FDQ_Append.ParamByName('telefone').AsString := Trim(LObj.GetValue('telefone', ''));
        FDQ_Append.ParamByName('celular').AsString := Trim(LObj.GetValue('celular', ''));
        FDQ_Append.ParamByName('endereco').AsString := Trim(LObj.GetValue('endereco', ''));
        FDQ_Append.ParamByName('email').AsString := Trim(LObj.GetValue('email', ''));
        ...
        if not FDQ_Append.IsEmpty then
          FCodigoRetorno := FDQ_Append.Fields[0].AsInteger;
      end;

      fDm.ZConnection.Commit;
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('codigo', TJSONIntegerNumber.Create(FCodigoRetorno));
      Result.JSonObject.AddPair('mensagem', 'Fornecedor inserido/atualizado com sucesso');
      Result.Menssage := 'Fornecedor Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
      ...
      begin
        if Assigned(fDm) and fDm.ZConnection.InTransaction then
          fDm.ZConnection.Rollback;
        Result.Id := 500;
      ...
      begin
        if Assigned(fDm) and fDm.ZConnection.InTransaction then
          fDm.ZConnection.Rollback;
        Result.Id := 400;
        Result.Menssage := 'Par�metros inv�lidos: ' + E.Message;
      end;
      on E: Exception do
      begin
        if Assigned(fDm) and fDm.ZConnection.InTransaction then
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Fornecedor para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Fornecedor ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Fornecedor ' + aId.ToString + ' exclu�do com sucesso';
      ...
      begin
        ...
        Result.Menssage := 'Acesso n�o permitido.';
        fDm.ZConnection.Rollback;
      end;
      on E: Exception do
      begin
  ...
  try
    try
      ...
      begin
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome do Cliente n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
      ...
      Result.Menssage := 'Cliente Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Cliente para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Cliente ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Cliente ' + aId.ToString + ' exclu�do com sucesso';
  ...
  try
    try
      ...
      begin
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome do Servi�o n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
        ...
        FDQ_Append.ParamByName('id').AsInteger := LObj.GetValue('codigo', 0);
        FDQ_Append.ParamByName('nome').AsString := Trim(LObj.GetValue('nome', ''));
        FDQ_Append.ParamByName('descricao').AsString := Trim(LObj.GetValue('descricao', ''));
        FDQ_Append.ParamByName('ativo').AsBoolean := LObj.GetValue('ativo', True);
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.ParamByName('usuario_id').AsInteger := aUsuarioId;
        FDQ_Append.Open;
      ...
      Result.Menssage := 'Categoria Inserida/Atualizada com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo da Categoria para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Categoria ' + aId.ToString + ', exclu�da com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Categoria ' + aId.ToString + ' exclu�da com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar as categorias.';
  ...
  try
    try
      ...
      begin
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome da Categoria n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
      ...
      Result.Menssage := 'Categoria Receber Inserida/Atualizada com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Categoria Receber ' + aId.ToString + ', exclu�da com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Categoria Receber ' + aId.ToString + ' exclu�da com sucesso';
  ...
  try
    try
      ...
      begin
        ...
        if Trim(LObj.GetValue('descricao','')) = '' then
        begin
          Result.Id := 404;
          Result.Menssage := 'Descri??o da Conta n�o informada.';
          fDm.ZConnection.Rollback;
          Exit;
        end;

        if LObj.GetValue('valor', 0) <= 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Valor da Conta n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;

        if LObj.GetValue('dataVencimento', 0) = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Data de Vencimento da Conta n�o informada.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
        ...
        FDQ_Append.ParamByName('id').AsInteger := LObj.GetValue('codigo', 0);
        FDQ_Append.ParamByName('usuario_id').AsInteger := aUsuarioId;
        FDQ_Append.ParamByName('fornecedor_id').AsInteger := LObj.GetValue('fornecedorId', 0);
        FDQ_Append.ParamByName('descricao').AsString := Trim(LObj.GetValue('descricao', ''));
        FDQ_Append.ParamByName('valor').AsFloat := LObj.GetValue('valor', 0);
        FDQ_Append.ParamByName('data_vencimento').AsDateTime := LObj.GetValue('dataVencimento', 0);
        FDQ_Append.ParamByName('id_categoria').AsInteger := LObj.GetValue('idCategoria', 0);
        FDQ_Append.ParamByName('pago').AsBoolean := LObj.GetValue('pago', False);
		    FDQ_Append.ParamByName('data_pagamento').Clear; // Always clear, since we don't use this field on update/insert
		    FDQ_Append.ParamByName('lancamento_origem_id').AsInteger := LObj.GetValue('lancamento_origem_id', 0);
		    FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;

        // Log SQL and parameters
        GravarLogJSON('uDataBase.Manager', 'SQL: ' + FDQ_Append.SQL.Text, 'ContasPagar_Atualizar', nil);
        ParamsLog := TStringBuilder.Create;
        try
          ParamsLog.Append('Par�metros: ');
          for K := 0 to FDQ_Append.Params.Count - 1 do
          begin
            if FDQ_Append.Params[K].IsNull then
              ParamsLog.AppendFormat('%s=NULL, ', [FDQ_Append.Params[K].Name])
            else
              ParamsLog.AppendFormat('%s=%s, ', [FDQ_Append.Params[K].Name, VarToStr(FDQ_Append.Params[K].Value)]);
          end;
      ...
      Result.Menssage := 'Conta a Pagar Inserida/Atualizada com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo da Conta a Pagar para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Conta a Pagar ' + aId.ToString + ', exclu�da com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Conta a Pagar ' + aId.ToString + ' exclu�da com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar as contas a pagar.';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 400;
        Result.Menssage := 'Codigo da Conta a Pagar n�o informado.';
        Exit;
      end;
      ...
      if aDataPagamento > 0 then
        FDQ_Update.ParamByName('data_pagamento').AsDateTime := aDataPagamento
      else
      ...
      begin
        fDm.ZConnection.Rollback;
        Result.Id := 404;
        Result.Menssage := 'Conta a Pagar n�o localizada.';
        Exit;
      end;
  ...
  try
    try
      ...
      begin
        ...
        if LObj.GetValue('data_vencimento', 0) = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Data de Vencimento da Conta n�o informada.';
          fDm.ZConnection.Rollback;
        ...
        FDQ_Append.ParamByName('id').AsInteger := LObj.GetValue('codigo', 0);
        FDQ_Append.ParamByName('usuario_id').AsInteger := aUsuarioId;
        FDQ_Append.ParamByName('cliente_id').AsInteger := LObj.GetValue('cliente_id', 0);
        FDQ_Append.ParamByName('descricao').AsString := Trim(LObj.GetValue('descricao', ''));
        FDQ_Append.ParamByName('valor').AsFloat := LObj.GetValue('valor', 0);
        FDQ_Append.ParamByName('data_vencimento').AsDateTime := LObj.GetValue('data_vencimento', 0);
        FDQ_Append.ParamByName('id_categoria').AsInteger := LObj.GetValue('id_categoria', 0);
        FDQ_Append.ParamByName('recebido').AsBoolean := LObj.GetValue('recebido', False);
        FDQ_Append.ParamByName('data_recebimento').Clear; // Always clear, since we don't use this field on update/insert
        FDQ_Append.ParamByName('lancamento_origem_id').AsInteger := LObj.GetValue('lancamento_origem_id', 0);
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.ParamByName('lancamento_origem').AsInteger := LObj.GetValue('lancamento_origem', 0);
      ...
      Result.Menssage := 'Conta a Receber Inserida/Atualizada com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo da Conta a Receber para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Conta a Receber ' + aId.ToString + ', exclu�da com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Conta a Receber ' + aId.ToString + ' exclu�da com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar as contas a receber.';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 400;
        Result.Menssage := 'Codigo da Conta a Receber n�o informado.';
        Exit;
      end;
      ...
      if aDataRecebimento > 0 then
        FDQ_Update.ParamByName('data_recebimento').AsDateTime := aDataRecebimento
      else
      ...
      begin
        fDm.ZConnection.Rollback;
        Result.Id := 404;
        Result.Menssage := 'Conta a Receber n�o localizada.';
        Exit;
      end;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os fornecedores.';
        GravarLogJSON('uDataBase.Manager', 'Fornecedor_Listar', 'uDataBase.Manager', Exception.Create(Result.Menssage));
      end
      else
      begin
...
begin
  ...
  try
    try
      ...
      fQuery.Connection := fDm.ZConnection;

      if APin <> '' then
      begin
        // Login por PIN (n�o valida senha)
        ...
        begin
          ...
          fJson := QueryToJSONObject(fQuery);
          fJson.AddPair('usuario', fQuery.FieldByName('NOME').AsString);
          Result.Id := 200;
          Result.JSonObject := fJson;
          GravarLogJSON('uDataBase.Manager', 'Login', 'uDataBase.Manager', Exception.Create('Usu�rio: ' + fQuery.FieldByName('NOME').AsString));
        end
        else
        begin
          Result.Id := 404;
          Result.Menssage := 'Usu�rio n�o localizado.';
      ...
      begin
        ...
        lSenha := fQuery.FieldByName('senha').AsString;

        if Trim(lSenha) = '' then
        begin
          Result.Id := 401;
          Result.Menssage := 'Senha n�o configurada para este usu�rio.';
          GravarLogJSON('uDataBase.Manager', 'Login', 'uDataBase.Manager', Exception.Create(Result.Menssage));
          Exit;
        end;
        ...
        begin
          Result.Id := 401;
          Result.Menssage := 'Senha inv�lida.';
          GravarLogJSON('uDataBase.Manager', 'Login', 'uDataBase.Manager', Exception.Create(Result.Menssage));
          Exit;
        end;
...
begin
  ...
  try
    try
      ...
      FDQ_Total := TZQuery.Create(nil);
      FDQ_Total.Connection := fDm.ZConnection;
      ...
      FDQ_Mensal := TZQuery.Create(nil);
      FDQ_Mensal.Connection := fDm.ZConnection;
      FDQ_Mensal.SQL.Text :=
      ...
      fArrayMensal := QueryToJSONArray(FDQ_Mensal);

      fJson := TJSONObject.Create;
      fJson.AddPair('total_receber', TJSONFloatNumber.Create(fTotalReceber));
      fJson.AddPair('total_pagar', TJSONFloatNumber.Create(fTotalPagar));
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os usu�rios.';
  ...
  try
    try
      ...
      begin
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome do Usu�rio n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
      ...
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('codigo', TJSONIntegerNumber.Create(FCodigoRetorno));
      Result.JSonObject.AddPair('mensagem', 'Usu�rio inserido/atualizado com sucesso');
      Result.Menssage := 'Usu�rio Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Usu�rio para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Usu�rio ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Usu�rio ' + aId.ToString + ' exclu�do com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 400;
        Result.Menssage := 'Codigo do Usu�rio n�o informado.';
        Exit;
      end;
      ...
      begin
        Result.Id := 400;
        Result.Menssage := 'Nova senha n�o informada.';
        Exit;
      end;
      ...
      begin
        ...
        Result.Id := 404;
        if aSenhaAtual <> '' then
          Result.Menssage := 'Usu�rio n�o localizado ou senha atual incorreta.'
        else
          Result.Menssage := 'Usu�rio n�o localizado.';
        Exit;
      end;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 400;
        Result.Menssage := 'Novo PIN n�o informado.';
        Exit;
      end;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os servi�os.';
...
begin
  ...
  try
    try
      ...
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('codigo', TJSONIntegerNumber.Create(FCodigoRetorno));
      Result.JSonObject.AddPair('mensagem', 'Servi�o inserido/atualizado com sucesso');
      Result.Menssage := 'Servi�o Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Servi�o para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Servi�o ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Servi�o ' + aId.ToString + ' exclu�do com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar as horas trabalhadas.';
  ...
  try
    try
      ...
      begin
        ...
        if LObj.GetValue('usuario_id', 0) = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Usu�rio n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;

        if LObj.GetValue('cliente_id', 0) = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Cliente n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;

        if LObj.GetValue('servico_id', 0) = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Servi�o n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;

        FDQ_Append.ParamByName('id').AsInteger := LObj.GetValue('codigo', 0);
        FDQ_Append.ParamByName('usuario_id').AsInteger := LObj.GetValue('usuario_id', 0);
        FDQ_Append.ParamByName('cliente_id').AsInteger := LObj.GetValue('cliente_id', 0);
        FDQ_Append.ParamByName('servico_id').AsInteger := LObj.GetValue('servico_id', 0);
        FDQ_Append.ParamByName('valor_hora').AsFloat := LObj.GetValue('valor_hora', 0);
        FDQ_Append.ParamByName('data_servico').AsDateTime := LObj.GetValue('data_servico', 0);
        FDQ_Append.ParamByName('hora_inicio').AsString := LObj.GetValue('hora_inicio', '00:00');
        FDQ_Append.ParamByName('hora_termino').AsString := LObj.GetValue('hora_termino', '00:00');
        FDQ_Append.ParamByName('quantidade_horas').AsFloat := LObj.GetValue('quantidade_horas', 0);
        FDQ_Append.ParamByName('total_horas').AsFloat := LObj.GetValue('total_horas', 0);
        FDQ_Append.ParamByName('observacoes').AsString := LObj.GetValue('observacoes', '');
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.Open;
      ...
      Result.Menssage := 'Horas trabalhadas Inseridas/Atualizadas com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo das Horas Trabalhadas para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Horas Trabalhadas ' + aId.ToString + ', exclu�das com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Horas Trabalhadas ' + aId.ToString + ' exclu�das com sucesso';
  ...
  try
    try
      ...
      begin
        ...
        FDQ_Append.ParamByName('cliente_id').AsInteger := LObj.GetValue('cliente_id', 0);
        FDQ_Append.ParamByName('servico_id').AsInteger := LObj.GetValue('servico_id', 0);
        FDQ_Append.ParamByName('data_abatimento').AsDateTime := LObj.GetValue('data_abatimento', 0);
        FDQ_Append.ParamByName('valor').AsFloat := LObj.GetValue('valor', 0);
        FDQ_Append.ParamByName('valor_hora').AsFloat := LObj.GetValue('valor_hora', 0);
        FDQ_Append.ParamByName('quantidade_horas').AsFloat := LObj.GetValue('quantidade_horas', 0);
        FDQ_Append.ParamByName('observacoes').AsString := LObj.GetValue('observacoes', '');
      ...
      Result.Menssage := 'Abatimento Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Abatimento para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Abatimento ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Abatimento ' + aId.ToString + ' exclu�do com sucesso';
  ...
  try
    try
      ...
      if AJSon.Count = 0 then begin
        Result.Id := 400; Result.Menssage := 'JSon n�o informado.'; Exit;
      end;
      ...
      begin
        LObj := AJSon.Items[I] as TJSONObject;
        if LObj.GetValue('usuario_id', 0) = 0 then begin
          Result.Id := 404; Result.Menssage := 'Usu�rio n�o informado.';
          fDm.ZConnection.Rollback; Exit;
        end;
        if LObj.GetValue('cliente_id', 0) = 0 then begin
          Result.Id := 404; Result.Menssage := 'Cliente n�o informado.';
          fDm.ZConnection.Rollback; Exit;
        end;
        if LObj.GetValue('servico_id', 0) = 0 then begin
          Result.Id := 404; Result.Menssage := 'Servi�o n�o informado.';
          fDm.ZConnection.Rollback; Exit;
        end;
        ...
        FDQ_Append.ParamByName('cliente_id').AsInteger := LObj.GetValue('cliente_id', 0);
        FDQ_Append.ParamByName('servico_id').AsInteger := LObj.GetValue('servico_id', 0);
        FDQ_Append.ParamByName('mes_origem').AsInteger := LObj.GetValue('mes_origem', 0);
        FDQ_Append.ParamByName('ano_origem').AsInteger := LObj.GetValue('ano_origem', 0);
        FDQ_Append.ParamByName('delta_horas').AsFloat := LObj.GetValue('delta_horas', 0);
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.ParamByName('usuario_cadastro').AsInteger := aUsuarioId;
        FDQ_Append.Open;
        if not FDQ_Append.IsEmpty then
      ...
      Result.Menssage := 'Horas excedidas inseridas/atualizadas com sucesso. Codigo: ' + FCodigoRetorno.ToString;
    except
      on E: EDatabaseError do begin
        if Assigned(fDm) and fDm.ZConnection.InTransaction then fDm.ZConnection.Rollback;
        Result.Id := 500; Result.Menssage := 'Erro no banco de dados: ' + E.Message;
      end;
      on E: EArgumentException do begin
        if Assigned(fDm) and fDm.ZConnection.InTransaction then fDm.ZConnection.Rollback;
        Result.Id := 400; Result.Menssage := 'Par�metros inv�lidos: ' + E.Message;
      end;
...
begin
  ...
  try
    try
      ...
      if aId = 0 then begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do registro para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Registro ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Registro ' + aId.ToString + ' exclu�do com sucesso';
      fDm.ZConnection.Commit;
    except
      on E: EDatabaseError do begin
        Result.Id := 500; Result.Menssage := 'Erro no banco de dados: ' + E.Message; fDm.ZConnection.Rollback;
      end;
      on E: EArgumentException do begin
        Result.Id := 400; Result.Menssage := 'Par�metros inv�lidos: ' + E.Message; fDm.ZConnection.Rollback;
      end;
      on E: EAccessViolation do begin
        Result.Id := 403; Result.Menssage := 'Acesso n�o permitido.'; fDm.ZConnection.Rollback;
      end;
      on E: Exception do begin
        Result.Id := 500; Result.Menssage := 'Erro inesperado: ' + E.Message; fDm.ZConnection.Rollback;
      end;
    end;
  finally
    if Assigned(FDQ_Select) then FDQ_Select.Free;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar as empresas.';
  ...
  try
    try
      ...
      begin
        ...
        if Trim(LObj.GetValue('razao_social','')) = '' then
        begin
          Result.Id := 404;
          Result.Menssage := 'Raz�o Social da Empresa n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;

        fCodigo := LObj.GetValue('codigo', 0);
        ...
        begin
          ...
          FDQ_Append.ParamByName('id').AsInteger := fCodigo;
        end
        else
        begin
        ...
        FDQ_Append.ParamByName('razao_social').AsString := Trim(LObj.GetValue('razao_social', ''));
        FDQ_Append.ParamByName('fantasia').AsString := Trim(LObj.GetValue('fantasia', ''));
        FDQ_Append.ParamByName('cnpj_cpf').AsString := Trim(LObj.GetValue('cnpj_cpf', ''));
        FDQ_Append.ParamByName('inscricao_estadual_identidade').AsString := Trim(LObj.GetValue('inscricao_estadual_identidade', ''));
        FDQ_Append.ParamByName('regime_tributario').AsString := Trim(LObj.GetValue('regime_tributario', ''));
        FDQ_Append.ParamByName('endereco').AsString := Trim(LObj.GetValue('endereco', ''));
        FDQ_Append.ParamByName('telefone').AsString := Trim(LObj.GetValue('telefone', ''));
        FDQ_Append.ParamByName('celular').AsString := Trim(LObj.GetValue('celular', ''));
        FDQ_Append.ParamByName('email').AsString := Trim(LObj.GetValue('email', ''));
      ...
      Result.Menssage := 'Empresa Inserida/Atualizada com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 400;
        Result.Menssage := 'Codigo da Empresa n�o informado.';
        Exit;
      end;
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('mensagem', 'Empresa exclu�da com sucesso');
      Result.Menssage := 'Empresa exclu�da com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os formul�rios.';
  ...
  try
    try
      ...
      begin
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome do Formul�rio n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
      ...
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('codigo', TJSONIntegerNumber.Create(FCodigoRetorno));
      Result.JSonObject.AddPair('mensagem', 'Formul�rio inserido/atualizado com sucesso');
      Result.Menssage := 'Formul�rio Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Formul�rio para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Formul�rio ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Formul�rio ' + aId.ToString + ' exclu�do com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os v�nculos usu�rio/formul�rio.';
  ...
  try
    try
      ...
      begin
        ...
        if LObj.GetValue('formulario_id', 0) = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Formul�rio n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
        ...
        FDQ_Append.ParamByName('id').AsInteger := LObj.GetValue('codigo', 0);
        FDQ_Append.ParamByName('usuario_id').AsInteger := LObj.GetValue('usuario_id', 0);
        FDQ_Append.ParamByName('formulario_id').AsInteger := LObj.GetValue('formulario_id', 0);
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.ParamByName('usuario_cadastro').AsInteger := aUsuarioId;
        FDQ_Append.Open;
      ...
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('codigo', TJSONIntegerNumber.Create(FCodigoRetorno));
      Result.JSonObject.AddPair('mensagem', 'V�nculo usu�rio/formul�rio inserido/atualizado com sucesso');
      Result.Menssage := 'V�nculo usu�rio/formul�rio Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do V�nculo para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'V�nculo ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'V�nculo ' + aId.ToString + ' exclu�do com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'Nenhuma permiss�o encontrada.';
      end
      else
      begin
        fJson := QueryToJSONArray(FDQ_Select);
...
begin
  ...
  try
    try
      ...
      for i :=   0 to aPermissoes.Count - 1 do
      begin
        lPermNome := aPermissoes.Items[i].Value;
        ...
        begin
          Result.Id := 400;
          Result.Menssage := 'Permiss�o "' + lPermNome + '" n�o encontrada.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('mensagem', 'Permiss�es salvas com sucesso');
...
begin
  ...
  try
    try
      ...
      begin
        lUfId := FDQ_Select.FieldByName('uf_id').AsInteger;
        lFormNome := FDQ_Select.FieldByName('formulario_nome').AsString;

        lPermArray := TJSONArray.Create;
        lPermQry := TZQuery.Create(nil);
        try
          lPermQry.Connection := fDm.ZConnection;
          lPermQry.Close;
          lPermQry.Sql.Clear;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os insumos.';
  ...
  try
    try
      ...
      begin
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome do Insumo n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
      ...
      FDQ_Append.ParamByName('id').AsInteger := LObj.GetValue('codigo', 0);
      FDQ_Append.ParamByName('nome').AsString := Trim(LObj.GetValue('nome', ''));
      FDQ_Append.ParamByName('unidade_medida').AsString := Trim(LObj.GetValue('unidade_medida', ''));
      FDQ_Append.ParamByName('custo_medio').AsFloat := LObj.GetValue('custo_medio', 0);
      FDQ_Append.ParamByName('ativo').AsBoolean := LObj.GetValue('ativo', True);
      FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
      FDQ_Append.ParamByName('usuario_id').AsInteger := aUsuarioId;
      FDQ_Append.Open;
      ...
      Result.Menssage := 'Insumo Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Insumo para excluir.';
      ...
      begin
        ...
        if lQtdFabricacao > 0 then
          lMsgVinculos := lMsgVinculos + Format(' fabrica��o (%d registro(s))', [lQtdFabricacao]);

        Result.Id := 400;
        Result.Menssage := 'Insumo n�o pode ser exclu�do pois possui v?nculo com:' + lMsgVinculos +
          '. Remova os v�nculos ou apenas inative o insumo.';
        fJson := TJSONObject.Create.AddPair('erro', Result.Menssage);
        Exit;
      end;
      ...
      fDm.ZConnection.Commit;
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Insumo ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Insumo ' + aId.ToString + ' exclu�do com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar as compras de insumo.';
...
var
  ...
  lQuantidade :Double;
  lDataCompra :TDate;
  lOldQuantidade: Double;
  FDQ_Old: TZQuery;
  lDelta: Double;
  FDQ_InsertCP: TZQuery;
  lPago :Boolean;
  ...
  try
    try
      ...
      begin
        ...
        lCodigo := LObj.GetValue('codigo', 0);
        lInsumoId := LObj.GetValue('insumo_id', 0);
        lQuantidade := LObj.GetValue('quantidade', 0);
        lDataCompra := LObj.GetValue('data_compra', 0);
        lOldQuantidade := 0;

        // If updating, read old values for stock delta calculation
        if lCodigo > 0 then
        begin
          FDQ_Old := TZQuery.Create(nil);
          try
            FDQ_Old.Connection := fDm.ZConnection;
            FDQ_Old.SQL.Text := 'SELECT quantidade FROM producao.compra_insumo WHERE id = :id';
            FDQ_Old.ParamByName('id').AsInteger := lCodigo;
            FDQ_Old.Open;
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Insumo n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
        ...
        FDQ_Append.ParamByName('id').AsInteger := lCodigo;
        FDQ_Append.ParamByName('insumo_id').AsInteger := lInsumoId;
        FDQ_Append.ParamByName('fornecedor_id').AsInteger := LObj.GetValue('fornecedor_id', 0);
        FDQ_Append.ParamByName('quantidade').AsFloat := lQuantidade;
        FDQ_Append.ParamByName('valor_total').AsFloat := LObj.GetValue('valor_total', 0);
        FDQ_Append.ParamByName('valor_unitario').AsFloat := LObj.GetValue('valor_unitario', 0);
        FDQ_Append.ParamByName('data_compra').AsDateTime := lDataCompra;
        FDQ_Append.ParamByName('observacao').AsString := Trim(LObj.GetValue('observacao', ''));
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.ParamByName('usuario_cadastro').AsInteger := aUsuarioId;
        FDQ_Append.Open;
        ...
        lDelta := (lQuantidade - lOldQuantidade);
        if lDelta <> 0 then
          AtualizarEstoqueInsumo(lInsumoId, lDelta, lDataCompra, aEmpresaId, fDm.ZConnection);

        RecalcularCustoMedio(lInsumoId, aEmpresaId, fDm.ZConnection);

        // If new compra and default category is set, create contas_pagar entry
        if (lCodigo = 0) and (LObj.GetValue('categoria_pagar_id', 0) > 0) then
        begin
          FDQ_InsertCP := TZQuery.Create(nil);
          try
            FDQ_InsertCP.Connection := fDm.ZConnection;

            lPago := LObj.GetValue('pago', False);
            ...
            FDQ_InsertCP.ParamByName('fornecedor_id').AsInteger := LObj.GetValue('fornecedor_id', 0);
            FDQ_InsertCP.ParamByName('insumo_id').AsInteger := lInsumoId;
            FDQ_InsertCP.ParamByName('valor').AsFloat := LObj.GetValue('valor_total', 0);
            FDQ_InsertCP.ParamByName('data_vencimento').AsDateTime := LObj.GetValue('data_vencimento', lDataCompra);
            FDQ_InsertCP.ParamByName('categoria_pagar_id').AsInteger := LObj.GetValue('categoria_pagar_id', 0);
            FDQ_InsertCP.ParamByName('pago').AsBoolean := lPago;
            if lPago then
              FDQ_InsertCP.ParamByName('data_pagamento').AsDateTime := LObj.GetValue('data_pagamento', lDataCompra)
            else
              FDQ_InsertCP.ParamByName('data_pagamento').Value := Null;
            FDQ_InsertCP.ParamByName('lancamento_origem_id').AsInteger := FCodigoRetorno;
      ...
      Result.Menssage := 'Compra Insumo Inserida/Atualizada com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo da Compra Insumo para excluir.';
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'Compra Insumo ' + aId.ToString + ' n�o localizada.';
        fDm.ZConnection.Rollback;
        Exit;
      end;

      lInsumoId := FDQ_Select.FieldByName('insumo_id').AsInteger;
      lQuantidade := FDQ_Select.FieldByName('quantidade').AsFloat;
      lDataCompra := FDQ_Select.FieldByName('data_compra').AsDateTime;
      ...
      AtualizarEstoqueInsumo(lInsumoId, -lQuantidade, lDataCompra, aEmpresaId, fDm.ZConnection);

      RecalcularCustoMedio(lInsumoId, aEmpresaId, fDm.ZConnection);
 
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Compra Insumo ' + aId.ToString + ', exclu�da com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Compra Insumo ' + aId.ToString + ' exclu�da com sucesso';
...
procedure TDataBaseManager.RecalcularCustoMedio(const aInsumoId: Integer; const aEmpresaId: Integer; const aFDConnection: TZConnection);
var
  FDQ_Calc: TZQuery;
begin
  FDQ_Calc := TZQuery.Create(nil);
  try
...
procedure TDataBaseManager.AtualizarEstoqueInsumo(const aInsumoId: Integer; const aDelta: Double; const aDataAtualizacao: TDateTime; const aEmpresaId: Integer; const aFDConnection: TZConnection);
var
  FDQ_Estoque: TZQuery;
begin
  FDQ_Estoque := TZQuery.Create(nil);
  try
...
procedure TDataBaseManager.AtualizarEstoqueProdutoFabricado(const aProdutoFabricadoId: Integer; const aDelta: Double; const aDataAtualizacao: TDateTime; const aEmpresaId: Integer; const aFDConnection: TZConnection);
var
  FDQ_Estoque: TZQuery;
begin
  FDQ_Estoque := TZQuery.Create(nil);
  ...
  try
    try
      ...
      begin
        ...
        FDQ_Append.ParamByName('id').AsInteger := lCodigo;
        FDQ_Append.ParamByName('insumo_id').AsInteger := lInsumoId;
        FDQ_Append.ParamByName('quantidade').AsFloat := LObj.GetValue('quantidade', 0);
        FDQ_Append.ParamByName('data_atualizacao').AsDateTime := LObj.GetValue('data_atualizacao', 0);
        FDQ_Append.ParamByName('observacao').AsString := Trim(LObj.GetValue('observacao', ''));
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.Open;
      ...
      Result.Menssage := 'Estoque Insumo Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo para excluir.';
        Exit;
      end;
  ...
  try
    try
      ...
      begin
        LObj := AJSon.Items[I] as TJSONObject;
        lCodigo := LObj.GetValue('codigo', 0);
        lProdutoId := LObj.GetValue('produto_fabricado_id', 0);

        if lProdutoId = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Produto n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
      ...
      Result.Menssage := 'Estoque Produto Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os produtos fabricados.';
  ...
  try
    try
      ...
      begin
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome do Produto Fabricado n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
        ...
        FDQ_Append.ParamByName('nome').AsString := Trim(LObj.GetValue('nome', ''));
        FDQ_Append.ParamByName('descricao').AsString := Trim(LObj.GetValue('descricao', ''));
        FDQ_Append.ParamByName('rendimento').AsFloat := LObj.GetValue('rendimento', 0);
        FDQ_Append.ParamByName('unidade_medida').AsString := Trim(LObj.GetValue('unidade_medida', ''));
        FDQ_Append.ParamByName('custo_unitario').AsFloat := LObj.GetValue('custo_unitario', 0);
        FDQ_Append.ParamByName('margem_lucro').AsFloat := LObj.GetValue('margem_lucro', 0);
        FDQ_Append.ParamByName('valor_venda_sugerido').AsFloat := LObj.GetValue('valor_venda_sugerido', 0);
        FDQ_Append.ParamByName('ativo').AsBoolean := LObj.GetValue('ativo', True);
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.Open;
      ...
      Result.Menssage := 'Produto Fabricado Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Produto Fabricado para excluir.';
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'Empresa n�o informada.';
        GravarLogJSON('uDataBase.Manager', 'ProdutoFabricado_Excluir', 'uDataBase.Manager', Exception.Create(Result.Menssage));
        Exit;
      end;
      ...
      begin
        Result.Id := 400;
        Result.Menssage := 'N�o � poss�vel excluir o produto fabricado, pois existem fabrica��es vinculadas a ele.';
        GravarLogJSON('uDataBase.Manager', 'ProdutoFabricado_Excluir', 'uDataBase.Manager', Exception.Create(Result.Menssage));
        Exit;
      end;
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Produto Fabricado ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Produto Fabricado ' + aId.ToString + ' exclu�do com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os ingredientes da receita.';
  ...
  try
    try
      ...
      begin
        ...
        if LObj.GetValue('produto_fabricado_id', 0) = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Produto Fabricado n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
        ...
        FDQ_Append.ParamByName('id').AsInteger := LObj.GetValue('codigo', 0);
        FDQ_Append.ParamByName('produto_fabricado_id').AsInteger := LObj.GetValue('produto_fabricado_id', 0);
        FDQ_Append.ParamByName('insumo_id').AsInteger := LObj.GetValue('insumo_id', 0);
        FDQ_Append.ParamByName('quantidade').AsFloat := LObj.GetValue('quantidade', 0);
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.Open;
      ...
      Result.Menssage := 'Receita Ingrediente Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Receita Ingrediente para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Receita Ingrediente ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Receita Ingrediente ' + aId.ToString + ' exclu�do com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os tipos de custo adicional.';
  ...
  try
    try
      ...
      begin
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome do Custo Adicional Tipo n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
      ...
      Result.Menssage := 'Custo Adicional Tipo Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Custo Adicional Tipo para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Custo Adicional Tipo ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Custo Adicional Tipo ' + aId.ToString + ' exclu�do com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar as fabrica��es.';
...
begin
  ...
  try
    try
      ...
      FDQ_Aux.Connection := fDm.ZConnection;
      ...
      begin
        ...
        fProdutoFabricadoId := LObj.GetValue('produto_fabricado_id', 0);
        fQuantidadeProduzida := LObj.GetValue('quantidade_produzida', 0);
        ...
        begin
          ...
          FDQ_Aux.ParamByName('fabricacao_id').AsInteger := lCodigo;
          FDQ_Aux.Open;
        ...
        FDQ_Append.ParamByName('data_fabricacao').AsDateTime := LObj.GetValue('data_fabricacao', 0);
        ...
        // Atualizar estoque apenas para novas fabrica��es
        if lCodigo = 0 then
        begin
          fDataFabricacao := LObj.GetValue('data_fabricacao', 0);
          ...
          begin
            lInsumoId := FDQ_Aux.FieldByName('insumo_id').AsInteger;
            lQuantidade := FDQ_Aux.FieldByName('quantidade').AsFloat;
            AtualizarEstoqueInsumo(lInsumoId, -lQuantidade, fDataFabricacao, aEmpresaId, fDm.ZConnection);
            FDQ_Aux.Next;
          end;

          // Adicionar produto fabricado ao estoque
          AtualizarEstoqueProdutoFabricado(fProdutoFabricadoId, fQuantidadeProduzida, fDataFabricacao, aEmpresaId, fDm.ZConnection);
        end;
      end;
      ...
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('codigo', TJSONIntegerNumber.Create(FCodigoRetorno));
      Result.JSonObject.AddPair('mensagem', 'Fabrica��o inserida/atualizada com sucesso');
      Result.Menssage := 'Fabrica��o Inserida/Atualizada com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo da Fabrica��o para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Fabrica��o ' + aId.ToString + ', exclu�da com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Fabrica��o ' + aId.ToString + ' exclu�da com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar os custos adicionais da fabrica��o.';
  ...
  try
    try
      ...
      begin
        ...
        if LObj.GetValue('fabricacao_id', 0) = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Fabrica��o n�o informada.';
          fDm.ZConnection.Rollback;
          Exit;
        end;

        if LObj.GetValue('custo_adicional_tipo_id', 0) = 0 then
        begin
          Result.Id := 404;
          Result.Menssage := 'Tipo de Custo Adicional n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;

        fFabricacaoId := LObj.GetValue('fabricacao_id', 0);
        ...
        FDQ_Append.ParamByName('custo_adicional_tipo_id').AsInteger := LObj.GetValue('custo_adicional_tipo_id', 0);
        FDQ_Append.ParamByName('valor').AsFloat := LObj.GetValue('valor', 0);
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.Open;
      ...
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('codigo', TJSONIntegerNumber.Create(FCodigoRetorno));
      Result.JSonObject.AddPair('mensagem', 'Custo Adicional da Fabrica��o inserido/atualizado com sucesso');
      Result.Menssage := 'Custo Adicional da Fabrica��o Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo do Custo Adicional da Fabrica��o para excluir.';
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'Custo Adicional da Fabrica��o n�o encontrado.';
        fDm.ZConnection.Rollback;
        Exit;
      end;
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Custo Adicional da Fabrica��o ' + aId.ToString + ', exclu�do com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Custo Adicional da Fabrica��o ' + aId.ToString + ' exclu�do com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi poss�vel localizar as vendas de produto.';
...
var
  ...
  lQuantidade :Double;
  lDataVenda :TDate;
  lProdutoFabricadoId :Integer;
  lCategoriaReceberId :Integer;
  lRecebido :Boolean;
begin
  with Result do
  begin
  ...
  try
    try
      ...
      FDQ_InsertCR.Connection := fDm.ZConnection;
      ...
      begin
        ...
        fUserId := aUsuarioId;
        if fUserId = 0 then
          fUserId := LObj.GetValue('usuario_id', 0);
        ...
        FDQ_Append.ParamByName('valor_unitario').AsFloat := LObj.GetValue('valor_unitario', 0);
        FDQ_Append.ParamByName('valor_total').AsFloat := LObj.GetValue('valor_total', 0);
        FDQ_Append.ParamByName('data_venda').AsDateTime := LObj.GetValue('data_venda', 0);
        FDQ_Append.ParamByName('observacao').AsString := Trim(LObj.GetValue('observacao', ''));
        FDQ_Append.ParamByName('empresa_id').AsInteger := aEmpresaId;
        FDQ_Append.Open;
        ...
        begin
          ...
          begin
            ...
            lQuantidade := LObj.GetValue('quantidade', 0);
            lDataVenda := LObj.GetValue('data_venda', 0);
            lProdutoFabricadoId := LObj.GetValue('produto_fabricado_id', 0);
            AtualizarEstoqueProdutoFabricado(lProdutoFabricadoId, -lQuantidade, lDataVenda, aEmpresaId, fDm.ZConnection);

            FDQ_InsertCR.Close;
            FDQ_InsertCR.Sql.Clear;

            lCategoriaReceberId := LObj.GetValue('categoria_receber_id', 0);
            ...
            lRecebido := LObj.GetValue('recebido', False);

            FDQ_InsertCR.ParamByName('usuario_id').AsInteger := fUserId;
            FDQ_InsertCR.ParamByName('cliente_id').AsInteger := LObj.GetValue('cliente_id', 0);
            FDQ_InsertCR.ParamByName('quantidade_str').AsString := LObj.GetValue('quantidade', '0');
            FDQ_InsertCR.ParamByName('pf_id').AsInteger := LObj.GetValue('produto_fabricado_id', 0);
            FDQ_InsertCR.ParamByName('valor').AsFloat := LObj.GetValue('valor_total', 0);
            FDQ_InsertCR.ParamByName('data_vencimento').AsDateTime := LObj.GetValue('data_vencimento', LObj.GetValue('data_venda', 0));
            FDQ_InsertCR.ParamByName('recebido').AsBoolean := lRecebido;
            if lRecebido then
              FDQ_InsertCR.ParamByName('data_recebimento').AsDateTime := LObj.GetValue('data_recebimento', LObj.GetValue('data_venda', 0))
            else
            ...
            FDQ_InsertCR.ParamByName('lancamento_origem_id').AsInteger := FCodigoRetorno;
            ...
            begin
              ...
              FDQ_InsertCR.ParamByName('vp_id').AsInteger := FCodigoRetorno;
      ...
      Result.JSonObject := TJSONObject.Create;
      Result.JSonObject.AddPair('codigo', TJSONIntegerNumber.Create(FCodigoRetorno));
      Result.JSonObject.AddPair('contas_receber_id', TJSONIntegerNumber.Create(fContasReceberId));
      Result.JSonObject.AddPair('mensagem', 'Venda Produto inserida/atualizada com sucesso');
      Result.Menssage := 'Venda Produto Inserida/Atualizada com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o c�digo da Venda Produto para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Venda Produto ' + aId.ToString + ', exclu�da com sucesso');
      fJson := Result.JSonObject;
      Result.Menssage := 'Venda Produto ' + aId.ToString + ' exclu�da com sucesso';
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 404;
        Result.Menssage := 'N�o foi possivel localizar os modulos.';
  ...
  try
    try
      ...
      begin
        ...
        begin
          Result.Id := 404;
          Result.Menssage := 'Nome do Modulo n�o informado.';
          fDm.ZConnection.Rollback;
          Exit;
        end;
      ...
      Result.Menssage := 'Modulo Inserido/Atualizado com sucesso. Codigo: ' + FCodigoRetorno.ToString;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 401;
        Result.Menssage := 'N�o foi informado o codigo do Modulo para excluir.';
      ...
      Result.Id := 200;
      Result.JSonObject := TJSONObject.Create.AddPair('mensagem', 'Modulo ' + aId.ToString + ', excluido com sucesso');
      fJson := Result.JSonObject;
...
begin
  ...
  try
    try
      ...
      begin
        lFormularioId := TJSONObject(aFormularios.Items[I]).GetValue('formulario_id', 0);
        lAbertura     := TJSONObject(aFormularios.Items[I]).GetValue('abertura', 0);
...
begin
  ...
  try
    try
      ...
      for i :=    0 to aModulos.Count - 1 do
      begin
        lModuloId := StrToIntDef(aModulos.Items[I].Value, 0);
        if lModuloId > 0 then
        begin
          FDQ_Exec.Close;
          FDQ_Exec.Sql.Clear;
...
begin
  ...
  try
    try
      ...
      begin
        Result.Id := 400;
        Result.Menssage := 'Codigo do vinculo n�o informado.';
        Exit;
      end;
